...
public class AddBackgroundColorAdapter extends RecyclerView.Adapter<AddBackgroundColorAdapter.GetViewHolder> {
    private ArrayList<String> pathList;
    private Context context;
    private int id =0;
    private GetPositionInterface getPositionInterface;

    public AddBackgroundColorAdapter(ArrayList<String> pathList, Context context, GetPositionInterface getPositionInterface) {
