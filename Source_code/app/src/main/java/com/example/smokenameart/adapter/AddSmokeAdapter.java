...
public class AddSmokeAdapter extends RecyclerView.Adapter<AddSmokeAdapter.GetViewHolder> {
    private ArrayList<String> pathList;
    private Context context;
    private int id =0;
    private GetPositionInterface getPositionInterface;

    public AddSmokeAdapter(ArrayList<String> pathList, Context context, GetPositionInterface getPositionInterface) {
